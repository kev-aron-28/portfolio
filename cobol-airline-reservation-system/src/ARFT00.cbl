      ...
      ***************************************************************** 
       ...
       01 WS-COMMAREA.                                                  
          COPY ARCOMMA.                                                 
       01 WS-CICS.                                                      
          05 WS-CICS-TRANSID PIC X(4) VALUE "FT00".                     
          05 WS-CICS-MAPSET PIC X(10) VALUE "MPFT00".                   
       ...
       PROCESS-PARA.                                                    
           IF FT00OPI = LOW-VALUES OR FT00OPI = SPACES THEN             
              MOVE 'YOU MUST SELECT AN OPTION' TO WS-MSG                
           ELSE IF FT00OPI NOT NUMERIC THEN                             
              MOVE 'IT MUST BE A NUMBER' TO WS-MSG                      
           ELSE                                                         
              MOVE FT00OPI TO WS-OPT                                    
       ...
       EVALUATE-OP-PARA.                                                
           EVALUATE WS-OPT                                              
              WHEN 1                                                    
                 EXEC CICS XCTL PROGRAM('ARFT01')                       
                 END-EXEC                                               
              WHEN 2                                                    
                 EXEC CICS XCTL PROGRAM('ARFT02')                       
                 END-EXEC                                               
              WHEN 3                                                    
                 EXEC CICS XCTL PROGRAM('ARFT03')                       
                 END-EXEC                                               
              WHEN OTHER                                                
                 PERFORM SEND-SCREEN-PARA                               
           END-EVALUATE.                                                
