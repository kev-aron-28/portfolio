       ...
       PROGRAM-ID. TEMPTL.                                              
      ***************************************************************** 
      * ARPF00: AIRPORT MENU CONTROLLER                                 
      *                                                                 
      ***************************************************************** 
       ...
       01 WS-COMMAREA.                                                  
          COPY ARCOMMA.                                                 
       01 WS-CICS.                                                      
          05 WS-CICS-TRANSID PIC X(4) VALUE "AP00".                     
          05 WS-CICS-MAPSET PIC X(10) VALUE "MPAP00".                   
       ...
       PROCESS-PARA.                                                    
           IF AP00OPI = LOW-VALUES OR AP00OPI = SPACES THEN             
              MOVE 'YOU MUST SELECT AN OPTION' TO WS-MSG                
           END-IF                                                       
           IF AP00OPI NOT NUMERIC THEN                                  
              MOVE 'IT MUST BE A NUMBER' TO WS-MSG                      
           ELSE                                                         
              MOVE AP00OPI TO WS-OPT                                    
       ...
       EVALUATE-OP-PARA.                                                
           EVALUATE WS-OPT                                              
              WHEN 1                                                    
                 EXEC CICS XCTL PROGRAM('ARAP01')                       
                 END-EXEC                                               
              WHEN 2                                                    
                 EXEC CICS XCTL PROGRAM('ARAP02')                       
                 END-EXEC                                               
              WHEN 3                                                    
                 EXEC CICS XCTL PROGRAM('ARAP03')                       
                 END-EXEC                                               
              WHEN OTHER                                                
                 PERFORM SEND-SCREEN-PARA                               
           END-EVALUATE.                                                
